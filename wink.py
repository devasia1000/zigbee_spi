...
def setWinkLightbulbState(value):
    user='devasia1000@gmail.com'
    passw='P1assword!'
    clientId='3ad1ab55dd6689ea8a2c532296c4165c'
    clientSecret='266e53a9099c06df407db562ed0b7c2f'
    baseUrl='https://winkapi.quirky.com/'

    data = auth(username=user, password=passw, client_id=clientId, client_secret=clientSecret, base_url=baseUrl)
    access_token = data['access_token']
    ...
    os.system('curl -X PUT -d "{\\"desired_state\\":{\\"powered\\":' + status_string + ',\\"brightness\\":1}}" -H "Authorization: Bearer ' + access_token + '" -H "Content-Type: application/json" "https://winkapi.quirky.com/light_bulbs/1149436"')
